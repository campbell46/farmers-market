...
class __TwigTemplate_13003f4286fefcd13d7aed5f90eaae01 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["links"] ?? null)) {
            ...
            // line 48
            echo "<nav";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [["nav", "links-inline"]], "method", false, false, true, 48), 48, $this->source), "html", null, true);
            echo ">";
            // line 49
...
";
    ...
    {
        return new Source("", "themes/bootstrap_barrio/templates/navigation/links--inline.html.twig", "/var/www/html/web/themes/bootstrap_barrio/templates/navigation/links--inline.html.twig");
    }
